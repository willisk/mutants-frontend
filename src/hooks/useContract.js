...
export function useNFTContract() {
  ...
  const contract = useMemo(() => NFTContract.connect(library), [library]);
...
export function useSerumContract() {
  ...
  const contract = useMemo(() => SerumContract.connect(library), [library]);
...
export function useMutantsContract() {
  ...
  const contract = useMemo(() => MutantsContract.connect(library), [library]);
